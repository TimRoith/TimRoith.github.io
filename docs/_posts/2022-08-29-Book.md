...
<img src="https://user-images.githubusercontent.com/44805883/168069022-0ded3cd5-00cc-486c-917c-3f1d49a0baf9.png" width="400px"/>
...
```LaTeX
\documentclass[WordMark=<path-to-file>, ExtraLogo=<path-to-file>]{fau-book}
```
